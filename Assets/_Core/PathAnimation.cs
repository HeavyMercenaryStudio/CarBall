...
public class PathAnimation : MonoBehaviour {
    ...
    void CatmulRom()
    {
        ...
        Vector2 p0 = new Vector2(points[0].position.x, points[0].position.y);
        Vector2 p1 = new Vector2(points[1].position.x, points[1].position.y);
        Vector2 p2 = new Vector2(points[2].position.x, points[2].position.y);
        Vector2 p3 = new Vector2(points[3].position.x, points[3].position.y);
